...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="  JOb"> </div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
        <a href="{{ route('Job') }}" class="menu-link">
          <div data-i18n="  Add JOb "> </div>
        </a>
      </li>
      <li class="menu-item">
 ...
 <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="  Company"> </div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
        <a href="{{ route('admincompany') }}" class="menu-link">
          <div data-i18n="  Add Company "> </div>
        </a>
      </li>
      <li class="menu-item">
        <a href="{{ route('list_company') }}" class="menu-link">
        <div data-i18n=" Show Company"> </div>
        </a>
      </li>
      <li class="menu-item">
        <a href="" class="menu-link">
        <div data-i18n=" edit Company"> </div>
        </a>
      </li>
    </ul>
  </li>
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n=" Connect Us"> </div>
    </a>
    <ul class="menu-sub">

      <li class="menu-item">
        <a href="{{ route('adminaconnect') }}" class="menu-link">
        <div data-i18n="  Show Connect Us"> </div>
        </a>
      </li>
      <li class="menu-item">
        <a href="/edit_role" class="menu-link">
        <div data-i18n=" Delete "> </div>
        </a>
      </li>
    </ul>
  </li>
...
<li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="About Us "> </div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
        <a href="{{ route('adminaboutus') }}" class="menu-link">
          <div data-i18n="Add About Us  ">  </div>
        </a>
      </li>
      <li class="menu-item">
        <a href="/" class="menu-link">
          <div data-i18n=" Show About Us  " >    </div>
        </a>
      </li>
      <li class="menu-item">
        <a href="/" class="menu-link">
        <div data-i18n=" Edit About Us"> </div>
        </a>
      </li>
    </ul>
  </li>
        ...
        <div class="pricing-plans">
          ...
          <div class="d-flex align-items-center justify-content-center flex-wrap gap-2 my-5 pt-sm-5">
            ...
            <div class="pricing-offer mt-n5 ms-n5 d-none d-sm-block">
              <img src="{{asset('assets/img/pages/pricing-arrow-light.png')}}" alt="arrow img" class="position-absolute scaleX-n1-rtl" data-app-dark-img="pages/pricing-arrow-dark.png')}}" data-app-light-img="pages/pricing-arrow-light.html">
