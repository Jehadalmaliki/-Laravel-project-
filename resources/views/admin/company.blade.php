...
<div class="row g-3">
  <div class="col-md-6">
    ...
    <input name="company_name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
  </div>
  <div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input name="Company_description" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
  </div>
