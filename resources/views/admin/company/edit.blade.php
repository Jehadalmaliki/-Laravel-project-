    ...
    <div class="col-md-12">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('update_company',$company->id) }}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <select  name="is_active" id="formtabs-country" class="select2 form-select" data-allow-clear="true">
                    ...
                    <option @if($company->is_active==1) selected @endif value="1">مفعل</option>
                    <option  @if($company->is_active==-1) selected @endif value="-1">معطل</option>
                  </select>
                </div>
              </div>
            </div>
